...
namespace eTopics.BusinessManagers {
    public class PostBusinessManager : IPostBusinessManager {
        ...
        public async Task<Post> DeletePost(EditViewModel deleteViewModel)
        {
           
          
            
            Post post = deleteViewModel.Post;
            int postid = deleteViewModel.Post.Id;
            post = await postService.Delete(post, postid);
